...
var auditTask = function(taskE1) {
  ...
  //convert to moment object at 6pm
...
$(".list-group").on("click", "span", function() {
  ...
  dateInput.datepicker({
    minDate: 1,
    onClose: function() {
      // when the calendar is closed, force a "change" event ont he 'dateInput'
      $(this).trigger("change");
    }
  });
...
$(".card .list-group").sortable({
  ...
  update: function(event) {
    ...
    $(this).children().each(function() {
      ...
      // add task data to teh temp array as an object
      tempArr.push({
        text: text,
        date: date
      });
